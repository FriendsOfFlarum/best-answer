...
var BestAnswerSettingsPage = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.content = function content() {
    return m("div", {
      ...
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-best-answer.admin.settings.remove_solutions_from_main_search'),
      help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-best-answer.admin.settings.remove_solutions_from_main_search_help')
    }), this.buildSettingComponent({
      type: 'boolean',
      setting: 'fof-best-answer.search.display_tags',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-best-answer.admin.settings.display_tags'),
      help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-best-answer.admin.settings.display_tags_help')
...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('fof-best-answer', function () {
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('fof-best-answer').registerPage(_components_BestAnswerSettingsPage__WEBPACK_IMPORTED_MODULE_2__["default"]).registerPermission({
    ...
    icon: 'far fa-comment',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('fof-best-answer.admin.permissions.allow_select_own_post'),
