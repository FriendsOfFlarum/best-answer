...
/***/ "./src/forum/addBestAnswerAction.tsx":
/*!*******************************************!*\
  !*** ./src/forum/addBestAnswerAction.tsx ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ addBestAnswerAction)
/* harmony export */ });
...
function addBestAnswerAction() {
  ...
  var isThisBestAnswer = function isThisBestAnswer(discussion, post) {
    ...
    var hasBestAnswer = discussion.hasBestAnswer();
  ...
  var actionLabel = function actionLabel(isBestAnswer) {
    return flarum_common_utils_extractText__WEBPACK_IMPORTED_MODULE_6___default()(flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans(isBestAnswer ? 'fof-best-answer.forum.remove_best_answer' : 'fof-best-answer.forum.this_best_answer'));
  };
  var saveDiscussion = function saveDiscussion(discussion, isBestAnswer, post) {
    ...
    return discussion.save({
      ...
      bestAnswerUserId: (_app$session$user = (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().session).user) == null ? void 0 : _app$session$user.id(),
  ...
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_utils_PostControls__WEBPACK_IMPORTED_MODULE_3___default()), 'moderationControls', function (items, post) {
    ...
    if (ineligible(discussion, post) || !flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().current.matches((flarum_forum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_4___default()))) return;
    items.add('bestAnswer', m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
  ...
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_CommentPost__WEBPACK_IMPORTED_MODULE_5___default().prototype), 'actionItems', function (items) {
    ...
    var isBestAnswer = isThisBestAnswer(discussion, post);
    var hasBestAnswer = discussion.bestAnswerPost() !== null;
    post.pushAttributes({
      isBestAnswer: isBestAnswer
    });
    if (ineligible(discussion, post) || !flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().current.matches((flarum_forum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_4___default()))) return;
...
/* harmony import */ var _components_SelectBestAnswerItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/SelectBestAnswerItem */ "./src/forum/components/SelectBestAnswerItem.tsx");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'headerItems', function (items) {
    var _discussion$bestAnswe;
    var post = this.attrs.post;
    var discussion = post.discussion();
    if (discussion != null && discussion.hasBestAnswer() && discussion.bestAnswerPost() && ((_discussion$bestAnswe = discussion.bestAnswerPost()) == null ? void 0 : _discussion$bestAnswe.id()) === post.id() && !post.isHidden()) {
      items.add('isBestAnswer', m(_components_SelectBestAnswerItem__WEBPACK_IMPORTED_MODULE_4__["default"], {
        post: post,
  ...
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_5___default().prototype), 'sidebarItems', function (items) {
    ...
    var post = discussion.hasBestAnswer() && discussion.bestAnswerPost();
    if (post && !post.isHidden() && post.number() !== 1 && !((_discussion$bestAnswe2 = discussion.bestAnswerPost()) != null && _discussion$bestAnswe2.isHidden())) {
      items.add('jumpToBestAnswer', m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_6___default()), {
        ...
        "aria-label": flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('fof-best-answer.forum.discussion.jump_to_best_answer_button')
...
/***/ "./src/forum/components/AwardedBestAnswerNotification.ts":
/*!***************************************************************!*\
  !*** ./src/forum/components/AwardedBestAnswerNotification.ts ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var BestAnswerBadge = /*#__PURE__*/function (_Badge) {
  ...
  BestAnswerBadge.initAttrs = function initAttrs(attrs) {
    ...
    attrs.label = flarum_common_utils_extractText__WEBPACK_IMPORTED_MODULE_3___default()(flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default().translator.trans('fof-best-answer.forum.answered_badge'));
  };
...
/* harmony import */ var _SelectBestAnswerItem__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./SelectBestAnswerItem */ "./src/forum/components/SelectBestAnswerItem.tsx");
...
var BestAnswerFooterPreview = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      className: flarum_common_utils_classList__WEBPACK_IMPORTED_MODULE_6___default()('Post-body', maxLines > 0 && 'Post-body--truncate'),
      style: {
        '--max-lines': maxLines
      }
  ...
  _proto.headerItems = function headerItems() {
    ...
    items.add('bestAnswer', m(_SelectBestAnswerItem__WEBPACK_IMPORTED_MODULE_7__["default"], {
      post: this.post,
  ...
  _proto.userItem = function userItem() {
    return m("li", {
      ...
      className: "PostUser"
    }, this.user && flarum_common_helpers_userOnline__WEBPACK_IMPORTED_MODULE_4___default()(this.user), m("h3", null, this.user ? m((flarum_common_components_Link__WEBPACK_IMPORTED_MODULE_5___default()), {
  ...
  _proto.metaItem = function metaItem() {
    ...
    }, flarum_common_helpers_humanTime__WEBPACK_IMPORTED_MODULE_9___default()(post.createdAt())));
  };
...
/***/ "./src/forum/components/BestAnswerInDiscussionNotification.ts":
/*!********************************************************************!*\
  !*** ./src/forum/components/BestAnswerInDiscussionNotification.ts ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/forum/components/SelectBestAnswerItem.tsx":
/*!*******************************************************!*\
  !*** ./src/forum/components/SelectBestAnswerItem.tsx ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var SelectBestAnswerItem = /*#__PURE__*/function (_Component) {
  ...
  _proto.getSetTime = function getSetTime(discussion) {
    if (!(discussion.bestAnswerSetAt != null && discussion.bestAnswerSetAt())) {
      return;
    }
    var bestAnswerSetAt = discussion.bestAnswerSetAt == null ? void 0 : discussion.bestAnswerSetAt();
    if (!bestAnswerSetAt) {
      return;
    }
    return flarum_common_helpers_humanTime__WEBPACK_IMPORTED_MODULE_5___default()(bestAnswerSetAt);
  };
  _proto.items = function items() {
    var _this$discussion$best, _this$discussion, _this$discussion$best2, _this$discussion2;
    ...
    var bestAnswerUser = (_this$discussion$best = (_this$discussion = this.discussion).bestAnswerUser) == null ? void 0 : _this$discussion$best.call(_this$discussion);
    bestAnswerUser && items.add('user', m("span", {
      ...
      user: (_this$discussion$best2 = (_this$discussion2 = this.discussion).bestAnswerUser) == null ? void 0 : _this$discussion$best2.call(_this$discussion2),
      time_set: this.getSetTime(this.discussion),
      a: m("a", {
        onclick: function onclick() {
          return m.route.set(flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default().route.user(bestAnswerUser));
        }
      })
    })));
    return items;
...
/***/ "./src/forum/components/SelectBestAnswerNotification.ts":
/*!**************************************************************!*\
  !*** ./src/forum/components/SelectBestAnswerNotification.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/forum/components/SolutionSearchItem.tsx":
/*!*****************************************************!*\
  !*** ./src/forum/components/SolutionSearchItem.tsx ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var flarum_tags_common_helpers_tagsLabel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! flarum/tags/common/helpers/tagsLabel */ "flarum/tags/common/helpers/tagsLabel");
/* harmony import */ var flarum_tags_common_helpers_tagsLabel__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(flarum_tags_common_helpers_tagsLabel__WEBPACK_IMPORTED_MODULE_5__);
...
var SolutionSearchItem = /*#__PURE__*/function (_Component) {
  function SolutionSearchItem() {
    var _this;
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    ...
    _this.query = void 0;
    _this.discussion = void 0;
    _this.bestAnswerPost = void 0;
    _this.mostRelevantPost = void 0;
    _this.tags = void 0;
    return _this;
  }
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(SolutionSearchItem, _Component);
  var _proto = SolutionSearchItem.prototype;
  _proto.oninit = function oninit(vnode) {
    _Component.prototype.oninit.call(this, vnode);
  ...
  _proto.view = function view() {
    return m("li", {
      ...
      "data-index": 'discussions' + this.discussion.id()
    }, m((flarum_common_components_Link__WEBPACK_IMPORTED_MODULE_3___default()), {
      href: flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().route.discussion(this.discussion, this.bestAnswerPost && this.bestAnswerPost.number() || 0)
    }, this.viewItems().toArray()));
  };
  _proto.discussionTitle = function discussionTitle() {
    return this.discussion.title();
  };
  _proto.bestAnswerContent = function bestAnswerContent() {
    var _this$bestAnswerPost;
    return (_this$bestAnswerPost = this.bestAnswerPost) == null ? void 0 : _this$bestAnswerPost.contentPlain();
  };
  _proto.mostRelevantContent = function mostRelevantContent() {
    var _this$mostRelevantPos;
    return (_this$mostRelevantPos = this.mostRelevantPost) == null ? void 0 : _this$mostRelevantPos.contentPlain();
  };
  _proto.viewItems = function viewItems() {
    var _this$mostRelevantCon, _this$bestAnswerConte;
    var items = new (flarum_common_utils_ItemList__WEBPACK_IMPORTED_MODULE_6___default())();
    flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().forum.attribute('showTagsInSearchResults') && items.add('tags', m("div", {
      className: "SolutionSearchResult-tags"
    }, flarum_tags_common_helpers_tagsLabel__WEBPACK_IMPORTED_MODULE_5___default()(this.tags)), 100);
    items.add('discussion-title', m("div", {
      className: "DiscussionSearchResult-title"
    }, flarum_common_helpers_highlight__WEBPACK_IMPORTED_MODULE_4___default()(this.discussionTitle(), this.query)), 90);
    !!this.mostRelevantPost && items.add('most-relevant', m("div", {
      className: "DiscussionSearchResult-excerpt"
    }, flarum_common_helpers_highlight__WEBPACK_IMPORTED_MODULE_4___default()((_this$mostRelevantCon = this.mostRelevantContent()) != null ? _this$mostRelevantCon : '', this.query, 100)), 80);
    !!this.bestAnswerPost && items.add('best-answer', m("div", {
      className: "DiscussionSearchResult-excerpt SolutionSearchResult-bestAnswer"
    }, flarum_common_helpers_highlight__WEBPACK_IMPORTED_MODULE_4___default()((_this$bestAnswerConte = this.bestAnswerContent()) != null ? _this$bestAnswerConte : '', this.query, 100)), 70);
    return items;
  };
  return SolutionSearchItem;
}((flarum_common_Component__WEBPACK_IMPORTED_MODULE_2___default()));
...
/* harmony import */ var _BestAnswerBadge__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./BestAnswerBadge */ "./src/forum/components/BestAnswerBadge.tsx");
/* harmony import */ var _SolutionSearchItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./SolutionSearchItem */ "./src/forum/components/SolutionSearchItem.tsx");
...
var SolutionSearchSource = /*#__PURE__*/function () {
  ...
  _proto.view = function view(query) {
    ...
    var results = (this.results.get(query) || []).map(function (discussion) {
      ...
      return m(_SolutionSearchItem__WEBPACK_IMPORTED_MODULE_5__["default"], {
        query: query,
        discussion: discussion,
        bestAnswerPost: bestAnswerPost,
    ...
    }, m(_BestAnswerBadge__WEBPACK_IMPORTED_MODULE_4__["default"], null), " ", flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default().translator.trans('fof-best-answer.forum.search.discussions_solutions_heading')), m("li", null, m((flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_3___default()), {
      icon: "fas fa-search",
  ...
  _proto.limit = function limit() {
    return 3;
  };
  _proto.queryMutators = function queryMutators() {
    return ['is:solved'];
  };
  _proto.setQueryString = function setQueryString(query) {
...
/***/ "./src/forum/components/SolvedFilter.tsx":
/*!***********************************************!*\
  !*** ./src/forum/components/SolvedFilter.tsx ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SolvedFilter)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/forum/app */ "flarum/forum/app");
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_app__WEBPACK_IMPORTED_MODULE_1__);
...
var SolvedFilter = /*#__PURE__*/function (_Component) {
  function SolvedFilter() {
    return _Component.apply(this, arguments) || this;
  }
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(SolvedFilter, _Component);
  var _proto = SolvedFilter.prototype;
  _proto.view = function view() {
    var _this = this;
    if (!this.shouldShowFilter()) return null;
    var selected = (flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().discussions).bestAnswer;
    var options = ['all', 'solved', 'unsolved'];
    return flarum_common_components_Dropdown__WEBPACK_IMPORTED_MODULE_3___default().component({
      buttonClassName: 'Button',
      label: flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans("fof-best-answer.forum.filter." + (options[selected] || Object.keys(options).map(function (key) {
        return options[Number(key)];
      })[0]) + "_label"),
      accessibleToggleLabel: flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-best-answer.forum.filter.accessible_label')
    }, Object.keys(options).map(function (value) {
      var label = options[Number(value)];
      ...
      return flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_4___default().component({
        ...
        active: active,
        onclick: function onclick() {
          (flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().discussions).bestAnswer = value;
          if (value === '0') {
            delete (flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().discussions).bestAnswer;
          }
          _this.reloadDiscussions();
        }
      }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans("fof-best-answer.forum.filter." + label + "_label"));
    }));
  };
  _proto.reloadDiscussions = function reloadDiscussions() {
    flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().discussions.refresh();
  };
  _proto.shouldShowFilter = function shouldShowFilter() {
    var _this$attrs = this.attrs,
      currentTag = _this$attrs.currentTag,
      alwaysShow = _this$attrs.alwaysShow;
    if (alwaysShow) return true;
    if (!flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().forum.attribute('showBestAnswerFilterUi')) return false;
    if (!(currentTag != null && currentTag.isQnA != null && currentTag.isQnA())) {
      if ((flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().discussions).bestAnswer) {
        delete (flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().discussions).bestAnswer;
        flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().discussions.refresh();
      }
      return false;
...
/* harmony export */ });
/* harmony import */ var _AwardedBestAnswerNotification__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AwardedBestAnswerNotification */ "./src/forum/components/AwardedBestAnswerNotification.ts");
...
/* harmony import */ var _BestAnswerInDiscussionNotification__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./BestAnswerInDiscussionNotification */ "./src/forum/components/BestAnswerInDiscussionNotification.ts");
/* harmony import */ var _SelectBestAnswerItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./SelectBestAnswerItem */ "./src/forum/components/SelectBestAnswerItem.tsx");
/* harmony import */ var _SelectBestAnswerNotification__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./SelectBestAnswerNotification */ "./src/forum/components/SelectBestAnswerNotification.ts");
/* harmony import */ var _SolutionSearchItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./SolutionSearchItem */ "./src/forum/components/SolutionSearchItem.tsx");
/* harmony import */ var _SolutionSearchSource__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./SolutionSearchSource */ "./src/forum/components/SolutionSearchSource.tsx");
/* harmony import */ var _SolvedFilter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./SolvedFilter */ "./src/forum/components/SolvedFilter.tsx");
...
var components = {
  ...
  SolutionSearchSource: _SolutionSearchSource__WEBPACK_IMPORTED_MODULE_7__["default"],
  ...
  SolutionSearchItem: _SolutionSearchItem__WEBPACK_IMPORTED_MODULE_6__["default"],
  SolvedFilter: _SolvedFilter__WEBPACK_IMPORTED_MODULE_8__["default"]
};
...
/***/ "./src/forum/extenders/extendDiscussionComposer.tsx":
/*!**********************************************************!*\
  !*** ./src/forum/extenders/extendDiscussionComposer.tsx ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ extendDiscussionComposer)
/* harmony export */ });
/* harmony import */ var flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flarum/common/extend */ "flarum/common/extend");
/* harmony import */ var flarum_common_extend__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/forum/app */ "flarum/forum/app");
...
function extendDiscussionComposer() {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__.extend)((flarum_forum_components_DiscussionComposer__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'headerItems', function (items) {
    ...
    // @ts-expect-error
    this.attrs.titlePlaceholder = flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-best-answer.forum.composer.titlePlaceholder');
...
/***/ "./src/forum/extenders/extendDiscussionListState.tsx":
/*!***********************************************************!*\
  !*** ./src/forum/extenders/extendDiscussionListState.tsx ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function extendDiscussionListState() {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'requestParams', function (params) {
...
/***/ "./src/forum/extenders/extendDiscussionSearchSource.tsx":
/*!**************************************************************!*\
  !*** ./src/forum/extenders/extendDiscussionSearchSource.tsx ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/common/extend */ "flarum/common/extend");
/* harmony import */ var flarum_common_extend__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var flarum_forum_components_DiscussionsSearchSource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! flarum/forum/components/DiscussionsSearchSource */ "flarum/forum/components/DiscussionsSearchSource");
/* harmony import */ var flarum_forum_components_DiscussionsSearchSource__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_components_DiscussionsSearchSource__WEBPACK_IMPORTED_MODULE_2__);



function extendDiscussionsSearchSource() {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_DiscussionsSearchSource__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'queryMutators', function (mutators) {
    // This will only apply when using flarum/core 1.8.6 or newer
    if (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('removeSolutionResultsFromMainSearch')) {
...
/* harmony import */ var _components_SolvedFilter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/SolvedFilter */ "./src/forum/components/SolvedFilter.tsx");
...
function extendIndexPage() {
  ...
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'viewItems', function (items) {
    ...
    items.add('solved-filter', m(_components_SolvedFilter__WEBPACK_IMPORTED_MODULE_3__["default"], {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   components: () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_15__.components),
/* harmony export */   extend: () => (/* reexport safe */ _extend__WEBPACK_IMPORTED_MODULE_16__["default"])
/* harmony export */ });
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flarum/forum/app */ "flarum/forum/app");
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_app__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_SelectBestAnswerNotification__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/SelectBestAnswerNotification */ "./src/forum/components/SelectBestAnswerNotification.ts");
/* harmony import */ var _addBestAnswerAction__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addBestAnswerAction */ "./src/forum/addBestAnswerAction.tsx");
/* harmony import */ var _addBestAnswerView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./addBestAnswerView */ "./src/forum/addBestAnswerView.tsx");
/* harmony import */ var _addAnsweredBadge__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addAnsweredBadge */ "./src/forum/addAnsweredBadge.tsx");
/* harmony import */ var _components_AwardedBestAnswerNotification__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/AwardedBestAnswerNotification */ "./src/forum/components/AwardedBestAnswerNotification.ts");
/* harmony import */ var _components_BestAnswerInDiscussionNotification__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/BestAnswerInDiscussionNotification */ "./src/forum/components/BestAnswerInDiscussionNotification.ts");
/* harmony import */ var _extenders_extendNotifications__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./extenders/extendNotifications */ "./src/forum/extenders/extendNotifications.ts");
/* harmony import */ var _addBestAnswerCountToUsers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./addBestAnswerCountToUsers */ "./src/forum/addBestAnswerCountToUsers.tsx");
/* harmony import */ var _common_addBestAnswerCountSort__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../common/addBestAnswerCountSort */ "./src/common/addBestAnswerCountSort.ts");
/* harmony import */ var _extenders_extendSearch__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./extenders/extendSearch */ "./src/forum/extenders/extendSearch.ts");
/* harmony import */ var _extenders_extendDiscussionSearchSource__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./extenders/extendDiscussionSearchSource */ "./src/forum/extenders/extendDiscussionSearchSource.tsx");
/* harmony import */ var _extenders_extendIndexPage__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./extenders/extendIndexPage */ "./src/forum/extenders/extendIndexPage.tsx");
/* harmony import */ var _extenders_extendDiscussionListState__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./extenders/extendDiscussionListState */ "./src/forum/extenders/extendDiscussionListState.tsx");
/* harmony import */ var _extenders_extendDiscussionComposer__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./extenders/extendDiscussionComposer */ "./src/forum/extenders/extendDiscussionComposer.tsx");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components */ "./src/forum/components/index.ts");
/* harmony import */ var _extend__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./extend */ "./src/forum/extend.ts");
...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('fof/best-answer', function () {
  (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().notificationComponents).selectBestAnswer = _components_SelectBestAnswerNotification__WEBPACK_IMPORTED_MODULE_1__["default"];
  (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().notificationComponents).awardedBestAnswer = _components_AwardedBestAnswerNotification__WEBPACK_IMPORTED_MODULE_5__["default"];
  (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().notificationComponents).bestAnswerInDiscussion = _components_BestAnswerInDiscussionNotification__WEBPACK_IMPORTED_MODULE_6__["default"];
  (0,_addAnsweredBadge__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_addBestAnswerAction__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_addBestAnswerView__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_addBestAnswerCountToUsers__WEBPACK_IMPORTED_MODULE_8__["default"])();
  (0,_common_addBestAnswerCountSort__WEBPACK_IMPORTED_MODULE_9__["default"])();
  (0,_extenders_extendNotifications__WEBPACK_IMPORTED_MODULE_7__["default"])();
  (0,_extenders_extendSearch__WEBPACK_IMPORTED_MODULE_10__["default"])();
  (0,_extenders_extendDiscussionSearchSource__WEBPACK_IMPORTED_MODULE_11__["default"])();
  (0,_extenders_extendIndexPage__WEBPACK_IMPORTED_MODULE_12__["default"])();
  (0,_extenders_extendDiscussionListState__WEBPACK_IMPORTED_MODULE_13__["default"])();
  (0,_extenders_extendDiscussionComposer__WEBPACK_IMPORTED_MODULE_14__["default"])();
});
...
/*!*********************************************************************************!*\
  !*** external "flarum.core.compat['forum/components/DiscussionsSearchSource']" ***!
  \*********************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = flarum.core.compat['forum/components/DiscussionsSearchSource'];
...
/***/ "flarum/tags/common/helpers/tagsLabel":
/*!**********************************************************************!*\
  !*** external "flarum.core.compat['tags/common/helpers/tagsLabel']" ***!
  \**********************************************************************/
/***/ ((module) => {

"use strict";
module.exports = flarum.core.compat['tags/common/helpers/tagsLabel'];
